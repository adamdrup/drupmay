...
/**
 * @file
 * Contains Drupal\tvi\Service\TaxonomyViewsIntegratorManager.
 */
...
class TaxonomyViewsIntegratorManager implements ContainerAwareInterface {
  ...
  public function getTaxonomyTermView(TermInterface $taxonomy_term) {
    ...
    // @todo: page views can override the term page title set in the view, but how can we do that for a block display?
